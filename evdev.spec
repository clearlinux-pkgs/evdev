...
%prep
%setup -q -n evdev-1.3.0
cd %{_builddir}/evdev-1.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603391790
...
cp %{_builddir}/evdev-1.3.0/LICENSE %{buildroot}/usr/share/package-licenses/evdev/4ab6a6236dcbd6da7e9d10d79d9c26d7975d2968
